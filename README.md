...
1. What is the narrative style - How would you like the AI to write? Is this going to be a Lovecraftian monster story? Or a tongue-in-cheek fantasy adventure? It's up to you.

1. File name for the save file - All save files get stored in the "saves" directory of the root folder. The game is automatically saved after each response generated by the game.
